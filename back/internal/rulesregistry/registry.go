...
var Registry = []models.ContentQualityRule{
	...
	},
	{
		...
		BlocksReadiness:       true,
		RequiresHumanDecision: false,
		VerificationMethod:    "contentquality.CheckArabicLanguage high-confidence deterministic findings",
		FixMethod:             models.RuleFixMethodManual,
		AutoApplyAllowed:      false,
		Version:               1,
		LastReviewedAt:        reviewedAt,
...
BlocksReadiness:       true,
RequiresHumanDecision: true,
VerificationMethod:    "contentquality.DetectSimilarity exact cluster — review-only duplicate signal",
FixMethod:             models.RuleFixMethodManual,
AutoApplyAllowed:      false,
Version:               1,
LastReviewedAt:        reviewedAt,
...
BlocksReadiness:       true,
RequiresHumanDecision: true,
VerificationMethod:    "contentquality.DetectSimilarity near cluster — review-only similarity signal",
FixMethod:             models.RuleFixMethodManual,
AutoApplyAllowed:      false,
Version:               1,
LastReviewedAt:        reviewedAt,
...
BlocksReadiness:       true,
RequiresHumanDecision: true,
VerificationMethod:    "contentquality.DetectSimilarity template cluster — review-only similarity signal",
FixMethod:             models.RuleFixMethodManual,
AutoApplyAllowed:      false,
Version:               1,
LastReviewedAt:        reviewedAt,
...
BlocksReadiness:       true,
RequiresHumanDecision: true,
VerificationMethod:    "normalized duplicate title in the current content inventory; academic metadata remains a human check",
FixMethod:             models.RuleFixMethodManual,
AutoApplyAllowed:      false,
Version:               1,
LastReviewedAt:        reviewedAt,

...
// One-click "إصلاح بالذكاء" from the content-quality drawer: runs the AI SEO
// optimizer for one item and persists it, so the editor form is never needed.
export const POST: APIRoute = async ({ request, cookies, locals }) => {
	...
	try {
		const response = await apiRawFetch(`/dashboard/seo/optimize-save/${type}/${id}`, {
			method: 'POST',
